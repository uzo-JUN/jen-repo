    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-black text-white">
      ...
      <main className="p-8 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold">🚀 JULIA KATHERINE SWISHER UNLOCK YOUR BALANCE</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-gray-800/50 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm text-gray-400">Gift Card Activation Fee</h3>
                  </div>
                ...
                <div className="bg-gray-800/50 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-purple-400">$8,000,000</p>
            ...
            <div className="flex flex-col items-center">
              <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-2xl p-6 border border-purple-500/30 text-center">
                ...
                <p className="text-lg text-purple-300 mb-4">Get up to $8,000,000</p>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">💎JULIA'S WITHDRAWAL PLANS</h2>
            <span className="text-sm text-gray-400">Choose Your Gift Card Activation Tier</span>
          </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">🚀 ONGOING SPACEX PROJECTS</h2>
            <div className="flex gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="ghost" className="text-blue-400 hover:text-blue-300">
                Real-time <ArrowUpRight className="w-4 h-4 ml-1" />
              </Button>
            </div>
